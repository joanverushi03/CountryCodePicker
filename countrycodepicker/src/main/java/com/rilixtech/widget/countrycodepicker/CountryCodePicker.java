...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void applyArrowIcon(TypedArray arr) {
        //text color
        Drawable arrowIcon = arr.getDrawable(R.styleable.CountryCodePicker_ccp_arrowIcon);

        mImvArrow.setImageDrawable(arrowIcon);
    }
